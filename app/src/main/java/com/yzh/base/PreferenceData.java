...
public class PreferenceData implements Serializable {
	...
	public static final String KEY_STR_CUR_DATE="str_cur_date";
	...
	public static final String KEY_CQB_COUNT_NUM="cqb_num"; //环形进度条 显示值
	public static final String KEY_POWER_VALUE="power_value"; //环形进度条 显示值
	public static final String KEY_PROGRESS_VALUE="progress_value"; //实际吸烟口数 显示值
	public static final String KEY_SEPARATE_NUM="separate_num";
	public static final String KEY_DEVICE_ALARM_DISPOSING="disposing_num";
	public static final String KEY_PUSH_MSG_COUNTNUM="push_msg_count";
	public static final String KEY_DEVICE_ALARMING="alarming_num";
	public static final String KEY_CQC_NG_NUM="cqc_ng_num";
	...
	/** 环形进度条 显示值(计划吸烟口数) **/
//	 环形进度条 显示值 保存
	public static void saveCpbCountNum(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_CQB_COUNT_NUM, key);
		editor.commit();
	}

	//	 环形进度条 显示值(计划吸烟口数) 获取
	public static int loadCpbCountNum(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_CQB_COUNT_NUM, 200);
	}


//	 功率设置值 保存
	public static void savePowerValue(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_POWER_VALUE, key);
		editor.commit();
	}

	//功率设置值 获取
	public static int loadPowerValue(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_POWER_VALUE, 5);
	}


	//实际吸烟口数 保存
	public static void saveProgressValue(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_PROGRESS_VALUE, key);
		editor.commit();
	}

	//实际吸烟口数 获取
	public static int loadProgressValue(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_PROGRESS_VALUE, 0);
	}
...
//	 已上线数量 保存
	...
	/** 用户名 **/
	public static void saveStrCurDate(Context context, String strCurDate) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putString(KEY_STR_CUR_DATE, strCurDate);
		editor.commit();
	}

	public static String loadStrCurDate(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getString(KEY_STR_CUR_DATE, "");
	}



	//	报警中数量 保存
	public static void saveAlarmingSum(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_DEVICE_ALARMING, key);
		editor.commit();
	}

	//	报警中数量 获取
	public static int loadAlarmingSum(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_DEVICE_ALARMING, -1);
	}
	...
	/** separate number  **/
	//	处理中数量 保存
	public static void saveAlarmDisposingSum(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_DEVICE_ALARM_DISPOSING, key);
		editor.commit();
	}

	//	处理中数量 获取
	public static int loadAlarmDisposingSum(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_DEVICE_ALARM_DISPOSING, -1);
	}


	/** separate number  **/
	//	推送消息数量 保存
	public static void savePushMsgCountNum(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_PUSH_MSG_COUNTNUM, key);
		editor.commit();
	}

	//	推送消息数量 读取
	public static int loadPushMsgCountNum(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_PUSH_MSG_COUNTNUM, 0);
	}

	/** separate number  **/
	//	产品全检不良数量 保存
	public static void saveCQCbadNumber(Context context, int key) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putInt(KEY_CQC_NG_NUM, key);
		editor.commit();
	}

	//	产品全检不良数量 读取
	public static int loadCQCbadNumber(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getInt(KEY_CQC_NG_NUM, 120);
	}
...
//		return sharedPreferences.getBoolean(KEY_AUTO_LOGIN_FLAG, false);
		return sharedPreferences.getBoolean(KEY_AUTO_LOGIN_FLAG, true);
	}
	...
	/** 密码 **/
	public static void saveLoginPassword(Context context, String head_url) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.putString(KEY_Login_Password, head_url);
		editor.commit();
	}
	...
	public static String loadLoginPassword(Context context) {
		SharedPreferences sharedPreferences = context.getApplicationContext()
				.getSharedPreferences(SHARED_PREFERENCE, Context.MODE_PRIVATE);
		return sharedPreferences.getString(KEY_Login_Password, "");
	}
